...
#	QCDDirectory = '/afs/cern.ch/work/v/vinguyen/diHiggsAnalysis/NTupleAnalyzerHH_nanoAOD_Full2017QCDNonIsoQuickTest_2020_05_27_23_39_32/SummaryFiles'
	# 2017 NanoAOD
...
######## STOCKNANO ###########
# 2017
#Rz_data_muon  = [1.1904, 0.03615]
#Rtt_data_muon = [0.8119, 0.07831]
#fbd_Muon     = [1.289, 0.01812]
#Rz_data_electron  = [1.0993, 0.01707]
#Rtt_data_electron = [0.8453, 0.06235]
#fbd_Electron = [5.8533, 0.7329]

# 2016
Rz_data_muon  = [0.771, 0.0197]
Rtt_data_muon = [0.744, 0.04277]
fbd_Muon     = [1.404, 0.11382]
Rz_data_electron  = [0.948, 0.016]
Rtt_data_electron = [0.976, 0.038]
fbd_Electron = [2.283, 0.427]
##################################
...
#	version_name = 'Testing_diHiggs_newNtuples_MuCutsMC0p49_'+analysisChannel # scriptflag
	version_name = 'testingStockNano_2016_'+analysisChannel # scriptflag
